...
import 'package:second_project/screens/ticket_view.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(" *** 2421", style: Styles.headLineStyle3),
                              ],
                            ),
          ...
          Positioned(
            left: AppLayout.getHeight(context, 21),
          ...
          Positioned(
            right: AppLayout.getHeight(context, 21),
            top: AppLayout.getHeight(context, 295),
